...
const PAGES_LINKS: IPageLink[] = [
  ...
  },
  {
    ...
    icon: "CloudOutlined",
    description:
      "The forecast page is the perfect way to stay informed about the weather in the places you care about. You can see the current weather in your home, work, and other important locations. You can also select different locations to view their forecast. The weather is updated in real-time and provides you with accurate information about temperature, humidity, wind, and precipitation. With this information, you can plan your day and stay informed about the weather conditions.",
  },
];

export const ARRANGED_PAGES = [
  PAGES_LINKS[2],
  PAGES_LINKS[3],
  PAGES_LINKS[4],
  PAGES_LINKS[1],
